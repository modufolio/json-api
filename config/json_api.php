...
return function (JsonApiConfigurator $api) {
    ...
    $api->resource('Modufolio\JsonApi\Tests\Fixtures\Entity\Contact')
        ->key('contact')
        ->fields(['id', 'firstName', 'lastName', 'email', 'phone', 'address', 'city', 'region', 'country', 'postalCode', 'createdAt', 'updatedAt', 'deletedAt'])
    ...
    $api->resource('Modufolio\JsonApi\Tests\Fixtures\Entity\Organization')
        ->key('organization')
        ->fields(['id', 'name', 'email', 'city', 'createdAt', 'updatedAt'])
